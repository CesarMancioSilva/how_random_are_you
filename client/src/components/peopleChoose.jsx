...
const BoardDice = () => {
    ...
    useEffect(()=>{
        if(ref.current==false){
            let a = document.getElementById("hReference2").offsetHeight
            console.log(a)
            setHeight(a/escala)
            for(let i=1;i<=escala;i++){
                ...
                document.querySelector('#escala2').appendChild(number)
            }
            setHeight(a/escala)
        }
        console.log(ref)
    ...
    return (
        <div className='p-4 px-6 rounded-md bg-white h-[100%] w-1/2 flex flex-col'> 
            ...
            <div id='hReference2' className='flex h-[88%]  '>
                <div id="escala2" className='h-full  w-[10%] flex flex-col-reverse'>
